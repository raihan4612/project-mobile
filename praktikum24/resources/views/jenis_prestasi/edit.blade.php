...
<div class="d-flex align-items-center mb-4">
    ...
    <h4 class="mb-0 fw-bold"><i class="bi bi-pencil-square text-warning me-2"></i>Edit Jenis Prestasi</h4>
</div>

<form action="{{ route('jenis-prestasi.update', $jenis->id) }}" method="POST">
    @csrf @method('PUT')
    <div class="card">
