...
<div class="d-flex align-items-center mb-4">
    ...
    <h4 class="mb-0 fw-bold"><i class="bi bi-shield-check text-warning me-2"></i>Edit Hak Akses</h4>
</div>

<div class="card" style="max-width: 680px;">
    <div class="card-header bg-warning text-dark">
        <i class="bi bi-key-fill me-2"></i>Form Edit Hak Akses
    </div>
    <div class="card-body">
        <form action="{{ route('update-hak-akses', $role->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-6 col-md-4">
                    <div class="form-check form-switch border rounded p-3 ps-5">
                        <input class="form-check-input" type="checkbox" name="can_create" id="can_create"
                               {{ old('can_create', $role->can_create) ? 'checked' : '' }}>
                ...
                <div class="col-6 col-md-4">
                    <div class="form-check form-switch border rounded p-3 ps-5">
                        <input class="form-check-input" type="checkbox" name="can_read" id="can_read"
                               {{ old('can_read', $role->can_read) ? 'checked' : '' }}>
                ...
                <div class="col-6 col-md-4">
                    <div class="form-check form-switch border rounded p-3 ps-5">
                        <input class="form-check-input" type="checkbox" name="can_update" id="can_update"
                               {{ old('can_update', $role->can_update) ? 'checked' : '' }}>
                ...
                <div class="col-6 col-md-4">
                    <div class="form-check form-switch border rounded p-3 ps-5">
                        <input class="form-check-input" type="checkbox" name="can_delete" id="can_delete"
                               {{ old('can_delete', $role->can_delete) ? 'checked' : '' }}>
                ...
                <div class="col-6 col-md-4">
                    <div class="form-check form-switch border rounded p-3 ps-5">
                        <input class="form-check-input" type="checkbox" name="can_export" id="can_export"
                               {{ old('can_export', $role->can_export) ? 'checked' : '' }}>
