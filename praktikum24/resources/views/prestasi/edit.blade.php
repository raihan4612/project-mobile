...
<div class="d-flex align-items-center mb-4">
    ...
    <h4 class="mb-0 fw-bold"><i class="bi bi-pencil-square text-primary me-2"></i>Edit Prestasi</h4>
</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="jenis_id" class="form-select @error('jenis_id') is-invalid @enderror">
                        ...
                        <option value="{{ $j->id }}" {{ (old('jenis_id', $prestasi->jenis_id) == $j->id) ? 'selected' : '' }}>
                            {{ $j->nama_jenis }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="tingkat_id" class="form-select @error('tingkat_id') is-invalid @enderror">
                        ...
                        <option value="{{ $t->id }}" {{ (old('tingkat_id', $prestasi->tingkat_id) == $t->id) ? 'selected' : '' }}>
                            {{ $t->nama_tingkat }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Upload Sertifikat Baru</label>
                    <input type="file" name="sertifikat" class="form-control @error('sertifikat') is-invalid @enderror"
                           accept=".pdf,.jpg,.jpeg,.png">
                    @if($prestasi->sertifikat)
                        <small class="text-success"><i class="bi bi-check-circle me-1"></i>Sudah ada sertifikat</small>
                    @endif
