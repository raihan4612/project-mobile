...
import '../repositories/prestasi_repository.dart';

class PrestasiProvider extends ChangeNotifier {
  PrestasiProvider(this._repository);

  final PrestasiRepository _repository;

  List<Prestasi> _items = [];
  bool _loading = false;
  ...
  List<Prestasi> get items => _items;
  ...
  Future<void> verifikasi({
    ...
    await _repository.verifikasi(id: id, status: status, catatan: catatan);
